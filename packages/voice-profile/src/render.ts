 ...
 *
 * Pure. No I/O, no banners, no "generated by" preamble. Writing files is
 * ./sync.ts's job, and keeping that out of here means `renderSystemPreamble`
 * does not ship a do-not-edit notice into an LLM prompt.
 */

import type { Evidence, VoiceFiles, VoiceProfile, VoiceRule } from './types.ts';
